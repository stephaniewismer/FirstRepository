...
class Course(Module):
    ...
    def __str__(self):
        return "Course: {0:s}".format(self.get_title())
...
class Seminar(Module):
    ...
    def __str__(self):
        return "Seminar in {0:s} under the topic: {1:s}" .format(self.get_title(), self.get_topic())
...
class Thesis(Module):
    ...
    def __str__(self):
        return "Bachelor Thesis on the topic: A promising {0:s} on {1:s} in the Research Group {2:s}".format(self.get_topic(), self.get_title(), self.get_research_group())
